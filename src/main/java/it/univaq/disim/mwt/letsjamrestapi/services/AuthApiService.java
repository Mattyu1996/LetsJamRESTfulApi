...
public abstract class AuthApiService {
    public abstract Response addUser(NewUser body, SecurityContext securityContext, UriInfo uriInfo) throws NotFoundException, SQLException;
    ...
    public abstract Response logout(SecurityContext securityContext, ContainerRequestContext req) throws NotFoundException, SQLException;
